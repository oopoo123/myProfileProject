...
public class PageDto {
	...
	private boolean next;//현재 보고 있는 페이지 이상으로 페이지가 있는지 여부 >
	private boolean prev;//현재 보고 있는 페이지 이하로 페이지가 있는지 여부 <
	...
	public PageDto(Criteria criteria, int total) {
		...
		// startPage 값은 1, 21, 31, 41.... 1보다 크면 무조건 prev가 true 표시되야함
